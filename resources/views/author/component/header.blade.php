<nav class="nav-bar"
    style="background-color: {{ $_COOKIE['mode'] == 'dark' ? 'var(--dark-clr)' : 'var(--white-clr)' }}; ">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu p-2 rounded-3 nav_author_link_dropdown mt-2"
                ...
                <li><a class="dropdown-item text-opacity-75 fw-light rounded-2" href="#">Danh sách bài
                        viết</a></li>
                <li>
                    <a class="dropdown-item change-mode text-opacity-75 fw-light rounded-2" href="#">Chế độ màn
                        hình
