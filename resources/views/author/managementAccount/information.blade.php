...
@section('main')
    <div class="container-fluid text-center py-5" style="background-color:#353536">
        <div class="container" style="width:448px">
            <div class="py-3 px-4 rounded-4 text-white text-start h-100 option mt-4" style="background-color: #2B2B2C">
                ...
                <form action="{{ route('author.post-news') }}" method='POST' enctype="multipart/form-data" class="mt-4 mb-3">
                    @csrf
                    <div class="position-relative mt-3">
                        ...
                        <label for="phone_number" class="position-absolute text-white text-opacity-75 px-2 py-1 input_label"
                            style="left:18px;background-color:#2B2B2C;">Số điện thoại</label>
                    </div>
                    <div class="position-relative mt-3">
                        ...
                        <label for="full_name" class="position-absolute text-white text-opacity-75 px-2 py-1 input_label"
                            style="left:18px;background-color:#2B2B2C;">Họ và tên</label>
                    </div>
                    <div class="position-relative mt-3">
                        ...
                        <label for="address" class="position-absolute text-white text-opacity-75 px-2 py-1 input_label"
                            style="left:18px;background-color:#2B2B2C;">Địa chỉ</label>
                    </div>
